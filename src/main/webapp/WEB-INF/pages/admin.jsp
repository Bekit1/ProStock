            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/admin">AdminRoom</a></li>
...
<table class="table table-striped" style="margin-top: 3%; width:35%" border="1" align="center">
    <thead>
    <tr>
        <td width="25%" class="header"><b>UserId</b></td>
        <td width="30%" class="header"><b>Username</b></td>
        <td width="45%" class="header"><b>Current balance</b></td>
    </tr>
    ...
    <tr style="padding-top: 0px">
        <td>${user.id}</td>
        <td>${user.login}</td>
        <td>${user.account.stringBalance}</td>
    </tr>
    </c:if>
    </c:forEach>
</table>
<div align="center">
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <c:if test="${byUsersPages ne null}">
                <c:forEach var="i" begin="1" end="${byUsersPages}">
...
<script src="/src/main/webapp/WEB-INF/bootstrap/assets/js/ie10-viewport-bug-workaround.js"></script>
